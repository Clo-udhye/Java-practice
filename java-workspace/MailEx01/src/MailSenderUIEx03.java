...
public class MailSenderUIEx03 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MailSenderUIEx03 frame = new MailSenderUIEx03();
	...
	public MailSenderUIEx03() {
		...
		btn1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				MailSender3 mailSender = new MailSender3(fromMail, fromPassword);
				try {
					mailSender.sendMail(textField1.getText(), textField3.getText(), textField2.getText(), textArea.getText(),type, attachedFile);
					dispose();
				} catch (UnsupportedEncodingException | MessagingException e) {
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(MailSenderUIEx03.this, "수신 메일을 확인하세요", "메일 전송 실패", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		...
		btn2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				int result = fileChooser.showOpenDialog(MailSenderUIEx03.this);
